...
public class MapGenRunia extends MapGenBase {
	...
	protected void spawnVillagers(){
		boolean b = MainClass.quests.hasQuest("miners");
		entities.add(new Villager(new Point(150, 150), b ? new SpecialText("Hello Bart,", "I have heard you are going to save the miners.", "Good luck with your mission!") : new SpecialText("You saved the miners, well done guys!")));
		entities.add(new Villager(new Point(930, 600), b ? new SpecialText("We can't do anything without the miners.", "They have all our important things.", "Save them please!") : new SpecialText("Our miay gems are back and the miners are safe.", "Thank you!")));
		entities.add(new Villager(new Point(300, 660), new SpecialText("Noooo, the aliens have come.", "They will kill everyone!", "We are all going to die!", "Nooo!", "It won't take long until they find our village.")));
		entities.add(new Villager(new Point(600, 210), new SpecialText("Hey Bart,", "You will need good weapons and armor to enter the forest.", "Have you visited the shops yet?")));
		entities.add(Villager.guard(new Point(630, 0), false, Items.miayArmor, Items.miaySword, new SpecialText("I will defend Runia until the end.")));
		entities.add(Villager.guard(new Point(690, 0), false, Items.miayArmor, Items.miaySword, new SpecialText("I will fight until I am tired.")));
	}
