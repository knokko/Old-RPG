...
public class MapGenFoidForest extends MapGenBase {
	...
	public ArrayList<Entity> getEnemies() {
		...
		enemies.add(new Foid(p, 3));
		enemies.add(new Foid(p, 4));
		enemies.add(new Foid(p, 5));
		enemies.add(new Mantid(p, 4));
		enemies.add(new Mantid(p, 3));
		enemies.add(new Wasp(p, 4));
		enemies.add(new Plant(p, 4));
		enemies.add(new Plant(p, 5));
		enemies.add(new Plant(p, 3));
		enemies.add(new Snake(p, 4));
		enemies.add(new Snake(p, 5));
		return enemies;
	}
