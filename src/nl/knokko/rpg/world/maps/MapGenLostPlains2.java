...
public class MapGenLostPlains2 extends MapGenBase {
	...
	public ArrayList<Entity> getEnemies() {
		...
		enemies.add(new Tarr(g, p, 10));
		enemies.add(new Tarr(g, p, 9));
		enemies.add(new Frode(g, p, 9));
		enemies.add(new Frode(g, p, 10));
		enemies.add(new Frode(g, p, 11));
		enemies.add(new Bird(g, p, 11));
		enemies.add(new Bird(g, p, 12));
		return enemies;
	}
