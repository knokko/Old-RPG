...
public class MapGenCyst extends MapGenBase {
	...
	public MapGenCyst(){
		...
		entities.add(new CursedEye(Game.game, new Point(2940, 4050), 70));
	}
	...
	public ArrayList<Entity> getEnemies(){
		...
		Game g = Game.game;
		Point p = new Point();
		enemies.add(new AstralWarrior(g, p, 28));
		enemies.add(new AstralWarrior(g, p, 29));
		enemies.add(new AstralWarrior(g, p, 30));
		enemies.add(new Spirit(g, p, 29));
		enemies.add(new Spirit(g, p, 30));
		enemies.add(new DarkSoul(g, p, 28));
		return enemies;
	}
	...
	public void placeChests() {
		...
		Point p = new Point();
		placeChest(47, new MonsterChest(118, new Point(1050, 4140), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)));
		placeChest(47, new MonsterChest(119, new Point(570, 4140), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)));
		placeChest(47, new MonsterChest(120, new Point(570, 4350), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)));
		placeChest(47, new MonsterChest(121, new Point(1050, 4350), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)));
		placeChest(47, new MonsterChest(122, new Point(1050, 4530), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)));
		placeChest(47, new MonsterChest(123, new Point(570, 4530), new GuiBattle(g, b, g.players(), new Entity[]{new AstralWolf(g, p, 35)}, false)).addItem(Items.cystBlade));
	}
	...
	public void loadData(){
		...
		try {
			...
			Game.console.println("Failed to load cyst data:");
	...
	public void saveData(){
		...
		try {
			...
			Game.console.println("Failed to save cyst data:");
			ex.printStackTrace(Game.console);
			Game.console.println();
		}
	}
