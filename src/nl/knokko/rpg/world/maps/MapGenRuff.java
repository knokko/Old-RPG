...
public class MapGenRuff extends MapGenBase {
	...
	public MapGenRuff(){
		...
		placePortals();
		spawnVillagers();
		if(GuiChat.hasConversation(GuiChat.ruff) && Game.game.quests.hasQuest("shaman"))
			conversations.add(new Conversation(GuiChat.ruff, new Point(2190, 660)));
	}

	public void spawnVillagers() {
		entities.add(new RuffVillager(new Point(1380, 780), Game.game, new SpecialText("I'm so happy we have guardians in our village.", "If the monsters would be able to come in...")));
		entities.add(new RuffVillager(new Point(1980, 870), Game.game, new SpecialText("Isn't this a beautiful day?")));
		entities.add(new RuffVillager(new Point(1290, 1110), Game.game, new SpecialText("I am going to buy a new house.", "Shall I take this house, or that one right?", "Or that house in the south...")));
		entities.add(new RuffVillager(new Point(1710, 1620), Game.game, new SpecialText("The shaman lives in this wooden house.")));
	}
