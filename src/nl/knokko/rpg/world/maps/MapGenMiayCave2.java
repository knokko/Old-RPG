...
public class MapGenMiayCave2 extends MapGenBase {
	...
	public ArrayList<Entity> getEnemies(){
		...
		enemies.add(new Troll(p, 10));
		enemies.add(new Troll(p, 11));
		enemies.add(new Troll(p, 12));
		enemies.add(new Spider(p, 10));
		enemies.add(new Bat(p, 11));
		enemies.add(new Bat(p, 12));
		return enemies;
	}
	...
	public void spawnMiners(){
		...
		if(q != null){
			if(q.progress < 1)
				entities.add(Villager.questMiner(new Point(5340, 5760), true, new ItemArmor[4], Items.pickaxe, new GuiChat(false, false, new SpecialText("Bart?", "You are here to safe us?"), new SpecialText("Yes, I am."), new SpecialText("Thank you very much.")).setSpeakers(new String[]{"Miner", "Bart", "Miner"})));
			if(q.progress < 2)
				entities.add(Villager.questMiner(new Point(5280, 5700), true, new ItemArmor[4], Items.pickaxe, new GuiChat(false, false, new SpecialText("Hey Bart,", "What are you doing here?"), new SpecialText("I am here to save you."), new SpecialText("You are going to save us?"), new SpecialText("Yes, like I said."), new SpecialText("Thank you.")).setSpeakers(new String[]{"Miner", "Bart", "Miner", "Bart", "Miner"})));
			if(q.progress < 3)
				entities.add(new Richard(new Point(5220, 5820)));
		}
	}
