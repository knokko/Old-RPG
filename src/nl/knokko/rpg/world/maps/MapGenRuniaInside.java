...
public class MapGenRuniaInside extends MapGenBase {
	...
	public MapGenRuniaInside() {
		...
		entities.add(new Anvil(Game.game, new Point(1410, 1320)));
		tiles2[47][44] = Tiles.anvil.id;
		
		entities.add(new Villager(new Point(1410, 240), g, false));
		entities.add(new Villager(new Point(270, 1260), g, false));
		entities.add(new Villager(new Point(1440, 1260), g, false));
		entities.add(new Villager(new Point(270, 330), g, new SpecialText("My friend still hasn't returned from the mines.", "Save him please.")));
	}
