...
public class MapGenMiayCave3 extends MapGenBase {
	...
	public MapGenMiayCave3(){
		...
		placePortals();
		spawnBosses();
		if(GuiChat.hasConversation(GuiChat.miay_cave_3) && Game.game.quests.hasQuest("miners"))
	...
	public ArrayList<Entity> getEnemies(){
		...
		Game g = Game.game;
		Point p = new Point();
		enemies.add(new Troll(g, p, 18));
		enemies.add(new Troll(g, p, 19));
		enemies.add(new Troll(g, p, 20));
		enemies.add(new Spider(g, p, 18));
		enemies.add(new Spider(g, p, 19));
		enemies.add(new Bat(g, p, 18));
		enemies.add(new Bat(g, p, 19));
		enemies.add(new Hotclaw(g, p, 15));
		return enemies;
	}
	...
	public void spawnBosses(){
		if(!Game.game.specialItems.hasItem(SpecialItems.DEMONIC_PEARL))
			entities.add(new Recking(Game.game, new Point(690, 3990), 15));
		if(Bosses.bosses.contains("fire dragon 1"))
			entities.add(new FireDragon(Game.game, new Point(1950, 3360), 10));
	}
}
