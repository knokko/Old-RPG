...
public class MapGenLostPlains extends MapGenBase {
	...
	public MapGenLostPlains() {
		...
		if(GuiChat.hasConversation(GuiChat.lost_plains_1) && MainClass.quests.hasQuest("miners"))
			conversations.add(new Conversation(GuiChat.lost_plains_1, new Point(5100, 2100)));
		else if(GuiChat.hasConversation(GuiChat.lost_plains_2) && !MainClass.quests.hasQuest("miners"))
	...
	public ArrayList<Entity> getEnemies(){
		...
		enemies.add(new Tarr(p, 8));
		enemies.add(new Tarr(p, 7));
		enemies.add(new Frode(p, 7));
		enemies.add(new Frode(p, 8));
		enemies.add(new Frode(p, 9));
		enemies.add(new Bird(p, 9));
		enemies.add(new Bird(p, 10));
		return enemies;
	}
