...
public class LastSpell extends Spell {
	...
	public LastSpell clone() {
		return new LastSpell(user, target, castPower, spellPower, mana, name, element, duration).setText(text);
	}
	...
	public static class Infect extends LastSpell {
		...
		@Override
		public Infect clone(){
			return new Infect(user, target, castPower, spellPower, mana, name, element, duration, effect.clone()).setText(text);
		}
	...
	public static class Empower extends LastSpell {
		...
		public Empower clone(){
			return new Empower(user, target, castPower, mana, name, element, duration, effect).setText(text);
		}
	...
	public static class Heal extends LastSpell{
		...
		@Override
		public Heal clone() {
			return new Heal(user, target, castPower, spellPower, mana, name, element, duration).setText(text);
		}
