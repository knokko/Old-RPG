...
public class GuiSaves extends Gui {
	...
	public void escapePressed(){
		game.currentGUI = new GuiMainMenu(game);
	}
	...
	public void buttonClicked(Button button){
		if(button instanceof FileButton){
			...
			if(button.name.equals("open")){
				if(selectedFile != null){
					game.currentGUI = new GuiSaveFile();
				}
			}
			if(button.name.equals("new game"))
				game.currentGUI = new GuiNewGame();
		}
	}
	...
	public class GuiNewGame extends Gui {
		...
		public GuiNewGame() {
			super(GuiSaves.this.game, null);
			updateButtons();
		}
		
		@Override
		public void escapePressed(){
			game.currentGUI = GuiSaves.this;
		}
