...
public class GuiHelpMenu extends Gui {
	...
	public GuiHelpMenu(Game theGame) {
		super(theGame, "sprites/gui/help.png");
		addFirstButtons();
	...
	private void initWeapons(){
		weaponsText = new SpecialText(Color.GRAY, new Font("TimesRoman", 1, factorX(40)), "Weapons and armor are important items in this game.",
