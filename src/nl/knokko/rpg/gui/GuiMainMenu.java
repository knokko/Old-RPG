...
public class GuiMainMenu extends Gui {
	...
	public void buttonClicked(Button button){
		if(button.name.matches("play game")){
			JukeBox.stop();
			MainClass.currentGUI = new GuiSaves();
				/*
				MainClass.currentGUI = new GuiChat(game, false, true, 
						...
						new SpecialText("If you have read all the messages, you can play the MainClass.", "You can walk with the arrows on your keyboard.", "You can open chests and talk with people with the space ", "bar."),
						...
						new SpecialText("It is important to become stronger in this MainClass.", "You will probably fight a lot.", "You can buy weapons or upgrade your characters."),
						...
						new SpecialText("You are now in the village Runia.", "There are shops here for armor, weapons and potions.", "Succes! And don't forget the help button in the menu.", "(You can open the menu with escape.)", "Click on 'next' to start the MainClass.")).setSpeaker("tutorial");
				*/
		}
		if(button.name.matches("delete data"))
			MainClass.currentGUI = new GuiDeleteData();
		if(button.name.matches("help menu"))
			MainClass.currentGUI = new GuiHelp();
		if(button.name.matches("quit game"))
			MainClass.close(false);
	}
		...
		*/
		...
		public void buttonClicked(Button button){
			...
			if(button.name.matches("no"))
				MainClass.currentGUI = GuiMainMenu.this;
		}
