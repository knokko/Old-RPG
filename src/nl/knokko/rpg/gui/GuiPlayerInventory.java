...
public class GuiPlayerInventory extends Gui{
	...
	public GuiPlayerInventory(Game game, Player owner) {
		super(game, null);
	...
	public void buttonClicked(Button button){
		...
		if(button.name.matches("next player"))
			game.currentGUI = new GuiPlayerInventory(game, game.nextPlayer(player));
		if(button.name.matches("special items"))
			game.currentGUI = new GuiSpecialItems(game);
	}
		...
		if(mouse.x >= factorX(549) && mouse.x <= factorX(581)){
			...
			if(mouse.y >= factorY(82) && mouse.y <= factorY(114)){
				if(stack == null && player.armor[0] != null){
					game.controller.mouseItemStack = new ItemStack(player.armor[0], 1);
					player.armor[0] = null;
				}
			...
			if(mouse.y >= factorY(115) && mouse.y <= factorY(147)){
				if(stack == null && player.armor[1] != null){
					game.controller.mouseItemStack = new ItemStack(player.armor[1], 1);
					player.armor[1] = null;
				}
			...
			if(mouse.y >= factorY(148) && mouse.y <= factorY(180)){
				if(stack == null && player.armor[2] != null){
					game.controller.mouseItemStack = new ItemStack(player.armor[2], 1);
					player.armor[2] = null;
				}
			...
			if(mouse.y >= factorY(181) && mouse.y <= factorY(213)){
				if(stack == null && player.armor[3] != null){
					game.controller.mouseItemStack = new ItemStack(player.armor[3], 1);
					player.armor[3] = null;
				}
