...
public class GuiBluePrints extends Gui {
	...
	public static final BluePrint fromString(String blueprint){
		try {
			...
			Game.console.println("failed to get blue print " + blueprint + ":");
	...
	public void paint(Graphics gr){
		...
		gr.fillRect(0, 0, factorX(1240), game.getHeight());
		gr.setColor(Color.GREEN);
		gr.fillRect(factorX(1240), 0, factorX(400), game.getHeight());
		gr.setColor(Color.YELLOW);
		gr.drawLine(factorX(1240), 0, factorX(1240), game.getHeight());
		super.paint(gr);
