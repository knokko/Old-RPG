...
public abstract class Quest {
	...
	public void saveData(boolean Catch){
		try {
			...
			MainClass.console.println("Failed to save the quests:");
	...
	public static class Reward {
		...
		public void apply(){
			MainClass.player.addXp(xp);
			MainClass.player2.addXp(xp);
			MainClass.player.inventory.money += money;
			int t = 0;
			while(t < items.length){
				MainClass.player.inventory.addItemStack(items[t]);
				++t;
			}
		}
	}
