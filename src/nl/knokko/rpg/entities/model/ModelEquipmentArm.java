...
public class ModelEquipmentArm extends ModelEquipment {
	...
	public ModelEquipmentArm(String sprite, ItemEquipment equipment, ItemEquipment weapon, Point base, Point rotate, Entity owner, boolean isGhost) {
		super(sprite, equipment, base, rotate, owner, isGhost);
		if(weapon != null){
	...
	public ModelEquipmentArm(String sprite, ItemEquipment equipment, ItemEquipment weapon, Point base, Point rotate, Entity owner){
		this(sprite, equipment, weapon, base, rotate, owner, false);
	}
	...
	public ModelEquipmentArm(String sprite, Point base, Point rotate, Entity owner) {
		this(sprite, null, null, base, rotate, owner);
	}
	
	public ModelEquipmentArm(String sprite, Point base, Point rotate, Entity entity, boolean isGhost) {
		this(sprite, null, null, base, rotate, entity, isGhost);
	}
