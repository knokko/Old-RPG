...
public class ModelEquipmentLeg extends ModelEquipment {
	...
	public ModelEquipmentLeg(String sprite, ItemEquipment legs, ItemEquipment boots, Point base, Point rotate, Entity owner, boolean isGhost) {
		super(sprite, legs, base, rotate, owner, isGhost);
		if(boots != null){
	...
	public ModelEquipmentLeg(String sprite, ItemEquipment legs, ItemEquipment boots, Point base, Point rotate, Entity owner){
		this(sprite, legs, boots, base, rotate, owner, false);
	}

	public ModelEquipmentLeg(String sprite, Point base, Point rotate, Entity owner) {
		this(sprite, null, null, base, rotate, owner);
	}
	
	public ModelEquipmentLeg(String sprite, Point base, Point rotate, Entity owner, boolean isGhost) {
		this(sprite, null, null, base, rotate, owner, isGhost);
	}
