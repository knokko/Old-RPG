...
public class DarkSoul extends Entity {
	...
	public DarkSoul(Game game, Point position, int level) {
	...
	protected void addBody(){
		...
		models.add(new ModelEquipmentLeg(n + "/leg.png", new Point(14, 16), new Point(1, 1), this));
		models.add(new ModelEquipment(n + "/arm.png", new Point(19, 6), new Point(1, 3), this));
		models.add(new ModelEquipment(n + "/body.png", new Point(13, 8), new Point(2, 3), this));
		models.add(new ModelEquipment(n + "/head.png", new Point(13, 1), new Point(2, 6), this));
		models.add(new ModelEquipmentArm(n + "/arm.png", new Point(19, 6), new Point(1, 3), this));
		models.add(new ModelEquipmentLeg(n + "/leg.png", new Point(14, 16), new Point(1, 1), this));
	}
