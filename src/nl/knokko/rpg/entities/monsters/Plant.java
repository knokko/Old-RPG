...
public class Plant extends Entity {
	...
	public Plant(Point spawn, int level) {
		super(spawn, level);
		addHumanAI();
		spirit = level;
		strength = level / 2;
	...
	protected void addBody(){
		...
		models.add(new ModelEquipmentLeg(n + "/leg.png", new Point(11, 20), new Point(1, 1), this, ArmorType.LEG));
		models.add(new ModelEquipment(n + "/arm.png", new Point(19, 10), new Point(1, 2), this, ArmorType.ARM));
		models.add(new ModelEquipment(n + "/body.png", new Point(13, 8), new Point(3, 6), this, ArmorType.CHESTPLATE));
		models.add(new ModelEquipment(n + "/head.png", new Point(13, 1), new Point(7, 5), this, ArmorType.HELMET));
		models.add(new ModelEquipmentArm(n + "/arm.png", new Point(19, 10), new Point(1, 2), this, ArmorType.ARM));
		models.add(new ModelEquipmentLeg(n + "/leg.png", new Point(14, 20), new Point(1, 1), this, ArmorType.LEG));
	}
}
