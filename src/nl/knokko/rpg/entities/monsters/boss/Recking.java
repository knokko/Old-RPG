...
public class Recking extends Entity {
	...
	public Recking(Point position, int level) {
	...
	private class Text extends GuiChat {
		...
		public Text() {
			super(false, false, new SpecialText[]{new SpecialText(Color.RED, "Nobody can enter my room unpunished.", "And especially not a human.", "You will pay for this..."), new SpecialText(Color.RED, "with your life!")});
			setSpeaker("Recking");
		}
		
		@Override
		public void finish(){
			MainClass.currentGUI = new GuiBattle(BackGrounds.red_cave, MainClass.players(), new Entity[]{null, Recking.this});
		}
	}
}
