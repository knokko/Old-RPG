...
public class FireDragon extends Entity {
	...
	public FireDragon(Game game, Point position, int level) {
	...
	@Override
	public void update(){
		if(position.distance(game.player.position) <= 100)
