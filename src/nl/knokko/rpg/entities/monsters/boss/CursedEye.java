...
public class CursedEye extends Entity {
	...
	public CursedEye(Point position, int level) {
	...
	public void update(){
		super.update();
		if(MainClass.specialItems.hasItem(SpecialItems.CURSED_EYE))
	...
	public void interact(){
		MainClass.currentGUI = new Text(this);
	}
	...
	protected void addBody(){
		...
		models.add(new ModelEquipmentArm(n + "/arm.png", new Point(19, -2), new Point(2, 12), this, ArmorType.ARM));
		models.add(new Model(n + "/leg.png", new Point(14, 12), new Point(1, 1), this));
		isHuman = true;
	}
	...
	private static class Text extends GuiChat {
		...
		@Override
		public void finish(){
			MainClass.currentGUI = new GuiBattle(BackGrounds.cyst, MainClass.players(), new Entity[]{null, eye});
		}
	}
}
