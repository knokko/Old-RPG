...
public class Richard extends Player {
	...
	public void interact(){
		...
		MainClass.player3 = this;
		String[] end = MainClass.quests.hasQuest(q) ? new String[]{"We should tell the other miners we can leave.", "Than we can leave this cave."} : new String[]{"Let's go to Ruff!"};
		MainClass.currentGUI = new GuiChat(false, 
