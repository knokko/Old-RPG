...
public class ItemWeapon extends ItemEquipment {
	...
	public ToolBar getToolBar(){
		ToolBar bar = new ToolBar(Color.BLUE, textColor, name, "Weapon", "", "Price: " + value, "", "Strike power: " + sharpness, "Ranged power: " + power, "Element: " + element.toString().toLowerCase());
		bar.setSize(200, 170);
		int t = 0;
	...
	public Point getRotationPoint() {
		return ArmorType.ARM.rotationPoint;
	}
}
